...
ALTER TABLE Zeit DROP FOREIGN KEY sieht;
ALTER TABLE QRCode DROP FOREIGN KEY FKQRCode579046;
ALTER TABLE Benutzer DROP FOREIGN KEY FKBenutzer71184;
ALTER TABLE Benutzer DROP FOREIGN KEY FKBenutzer222378;
...
CREATE TABLE Zeit (ID int(10) NOT NULL AUTO_INCREMENT, BenutzerUsername2 varchar(255), Datum date, GemesseneZeit time(6), KletterwandName varchar(255) NOT NULL, BenutzerUsername varchar(255) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB;
CREATE TABLE Benutzer (Username varchar(255) NOT NULL, BenutzerUsername2 varchar(255), BenutzerUsername varchar(255), Password varchar(255), Profilbild varchar(255), Discriminator varchar(255) NOT NULL, PRIMARY KEY (Username)) ENGINE=InnoDB;
...
ALTER TABLE Zeit ADD INDEX sieht (BenutzerUsername2), ADD CONSTRAINT sieht FOREIGN KEY (BenutzerUsername2) REFERENCES Benutzer (Username);
...
ALTER TABLE Benutzer ADD INDEX FKBenutzer71184 (BenutzerUsername), ADD CONSTRAINT FKBenutzer71184 FOREIGN KEY (BenutzerUsername) REFERENCES Benutzer (Username);
ALTER TABLE Benutzer ADD INDEX FKBenutzer222378 (BenutzerUsername2), ADD CONSTRAINT FKBenutzer222378 FOREIGN KEY (BenutzerUsername2) REFERENCES Benutzer (Username);
INSERT INTO Kletterwand(Name, StartTag, EndTag, Lat, Lon) VALUES ('Kletterwand Ost', 'start1', 'end1', 42.0, 9.2);
INSERT INTO Frage(Frage, Antwort1, Antwort2, Antwortrichtig, TippAufAntwort) VALUES ('Was ist 1+1?', '1', '2', '3', 'überleg mal...');
INSERT INTO Benutzer(Username, BenutzerUsername2, BenutzerUsername, Password, Profilbild, Discriminator) VALUES ('michaheiss', null, null, 'password1', 'http://example.com/image.jpg', 'admin');
INSERT INTO Benutzer(Username, BenutzerUsername2, BenutzerUsername, Password, Profilbild, Discriminator) VALUES ('janleppich', null, null, 'S4fe-Pw', 'http://example.net/image.png', 'user');
