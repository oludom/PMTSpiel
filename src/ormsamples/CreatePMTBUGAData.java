		...
		try {
			session.doWork(new org.hibernate.jdbc.Work() {
				public void execute(java.sql.Connection conn) throws java.sql.SQLException {
					...
					statement.executeUpdate("INSERT INTO Benutzer(Username, KletterwandAdmin, QRCodeAdmin, Password, Profilbild, Discriminator) VALUES ('michaheiss', null, null, 'password1', 'http://example.com/image.jpg', 'admin')");
					statement.executeUpdate("INSERT INTO Benutzer(Username, KletterwandAdmin, QRCodeAdmin, Password, Profilbild, Discriminator) VALUES ('janleppich', null, null, 'S4fe-Pw', 'http://example.net/image.png', 'user')");
