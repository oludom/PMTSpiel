...
public class PMTBUGAPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "PMTBUGA";
	...
	private PMTBUGAPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new PMTBUGAPersistentManager();
		}
