...
public class BugaBesucherDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public BugaBesucherDetachedCriteria() {
		...
		Leistung = new CollectionExpression("ORM_Leistung", this.getDetachedCriteria());
	}
	...
	public pmt.spielspaß.codegenerierung.ZeitDetachedCriteria createLeistungCriteria() {
		return new pmt.spielspaß.codegenerierung.ZeitDetachedCriteria(createCriteria("ORM_Leistung"));
	}
