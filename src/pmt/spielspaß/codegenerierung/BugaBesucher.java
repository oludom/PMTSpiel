...
public class BugaBesucher extends pmt.spielspaß.codegenerierung.Benutzer {
	...
	private java.util.Set this_getSet (int key) {
		...
		else if (key == pmt.spielspaß.codegenerierung.ORMConstants.KEY_BUGABESUCHER_LEISTUNG) {
			return ORM_leistung;
		}
	...
	private java.util.Set ORM_leistung = new java.util.HashSet();
	...
	private void setORM_Leistung(java.util.Set value) {
		this.ORM_leistung = value;
	}
	
	private java.util.Set getORM_Leistung() {
		return ORM_leistung;
	}
	
	public final pmt.spielspaß.codegenerierung.ZeitSetCollection leistung = new pmt.spielspaß.codegenerierung.ZeitSetCollection(this, _ormAdapter, pmt.spielspaß.codegenerierung.ORMConstants.KEY_BUGABESUCHER_LEISTUNG, pmt.spielspaß.codegenerierung.ORMConstants.KEY_ZEIT_SPIELER, pmt.spielspaß.codegenerierung.ORMConstants.KEY_MUL_ONE_TO_MANY);
